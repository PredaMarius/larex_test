                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU').sort(dynamicMultipleSort('pozitieLista','denumire')).map(option => (
                          <option
                            key={option.key}
                        ...
                        {this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0]?
                          this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].materialeCompatibile[0]?
                            this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].materialeCompatibile.filter(material=>material.activ.toUpperCase()!=='NU')[0]?
                              this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].materialeCompatibile.filter(material=>material.activ.toUpperCase()!=='NU').sort(dynamicMultipleSort('pozitieLista','denumire')).map(option => (
                                <option
                                  key={option.key}
                                  value={option.denumire}
                                >
                    ...
                    >
                      ...
                      >
                        ...
                        {materiale.filter(mat=> mat.key===currentItem.material && mat.tipProdus.toUpperCase()==='RO')[0]?
                          materiale.filter(mat=> mat.key===currentItem.material && mat.tipProdus.toUpperCase()==='RO')[0].coduris.filter(cod=>cod.activ.toUpperCase()!=='NU')[0]?
                            materiale.filter(mat=> mat.key===currentItem.material && mat.tipProdus.toUpperCase()==='RO')[0].coduris.filter(cod=>cod.activ.toUpperCase()!=='NU').sort(dynamicSort('denumire')).map(option => (
                              <option
                                key={option.denumire}
                                value={option.denumire}
                              >
                    ...
                    >
                      <TextField
                        disabled={this.handleCoteFinale()}
                        error={errors.m15m.mesaj ?true:false}
                        fullWidth
                        helperText={errors.m15m.mesaj ? errors.m15m.mesaj  :''}
                        InputLabelProps={{shrink:true}}
                        inputProps={{style: { textAlign: 'right' }}}
                        InputProps={{
                          endAdornment: <InputAdornment position="end">mm</InputAdornment>,
                        ...
                        onChange={this.onChange}
                        onKeyDown={this.handlerKeyDown}
                        required={this.handleInaltimeFinalaRequired()}
                    ...
                    >
                      <TextField
                        ...
                        error={errors.m5m.mesaj || errors.m7m.mesaj || errors.m12m.mesaj || errors.m16m.mesaj ? true:false}
                        fullWidth
                        helperText={errors.m5m.mesaj || errors.m7m.mesaj || errors.m12m.mesaj || errors.m16m.mesaj? (errors.m5m.mesaj? errors.m5m.mesaj + ' ':'') + (errors.m7m.mesaj? errors.m7m.mesaj + ' ':'')+(errors.m12m.mesaj? errors.m12m.mesaj + ' ':'')+(errors.m16m.mesaj? errors.m16m.mesaj + ' ':'') :''}
                        InputLabelProps={{shrink:true}}
                        label="Ax"
                        margin="dense"
                        name="ax"
                      ...
                      >
                        ...
                        {this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0]?
                          this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].culoriCompatibile.filter(culoare=>culoare.activ.toUpperCase()!=='NU' && culoare.componenta==='COMPONENTA')[0]?
                            this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].culoriCompatibile.filter(culoare=>culoare.activ.toUpperCase()!=='NU' && culoare.componenta==='COMPONENTA').sort(dynamicMultipleSort('pozitieLista','denumire')).map(option => (
                              <option
                                key={option.key}
                                value={option.denumire}
                              >
                        ...
                        {this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)?
                          this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0]?
                            this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].optionaleCompatibile.filter(optional=>optional.ax===currentItem.ax && optional.activ.toUpperCase()!=='NU')[0]?
                              this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].optionaleCompatibile.filter(optional=>optional.ax===currentItem.ax && optional.activ.toUpperCase()!=='NU').sort(dynamicMultipleSort('pozitieLista','denumire')).map(option => (
                                <option
                                  key={option.key}
                                  value={option.denumire}
                                >
