                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {this.produse.sort(dynamicMultipleSort('pozitieLista','denumire')).map(option => (
                        <option
                          key={option.key}
                  ...
                  >
                    <TextField
                      error={errors.m7m.mesaj ? true:false}
                      helperText={errors.m7m.mesaj? (errors.m7m.mesaj? errors.m7m.mesaj + ' ':''):''}
                      fullWidth
                      InputLabelProps={{shrink:true}}
                      label="Culoare"
                      margin="dense"
