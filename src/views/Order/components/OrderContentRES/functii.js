...
export const pretRe=(produse,tipSubprodus=0, lungime=0, inaltime=0, culoareLamela=0, culoareCaseta=0, tipActionare=0, optional1=0, optional2=0,optional3=0, preturitabelare, buc=0)=>{  // returneaza pretul  intregului rulou, inclusiv actionare si optionale.
  ...
  switch(tipActionare) {
    ...
    case 21: // MOTOR MARE + TELECOMANDA
      if( optional1 !== 48 && optional2 !== 48 && optional3!== 48 && optional1 !== 59 && optional2 !== 59 && optional3!== 59 ){  //' daca optionalul este diferit de LegaturaCardanicaPtCon + Manivela sau LegaturaCardanicaPtCon
