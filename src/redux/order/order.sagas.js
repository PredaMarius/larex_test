...
export function* getOrders({payload:{idFirma,tipProdus, subTip}}){
  try{
    yield put(setLoading(true))
    const orders=subTip? yield strapi.getEntries('comandas',{idFirma,tipProdus, subTip, _limit:-1}): yield strapi.getEntries('comandas',{idFirma,tipProdus, _limit:-1})
